...
import com.hebe.report.bean.MoreResultBean;
...
public class MoreReportResultActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.morereport_result_activity);
        x.view().inject(this);
    ...
    public void getinfo() {
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                closeProgressDialog();
                MoreResultBean bean = Utils.jsonParase(result, MoreResultBean.class);
                if (bean != null && bean.getCode() == 200) {
                    textview1.setText(bean.getData().getType_name());
                    textview2.setText(bean.getData().getContent());
                    isget = 1;
                } else {
                    showToast("请重试");
                }
