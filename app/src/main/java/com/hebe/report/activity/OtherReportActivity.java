...
public class OtherReportActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.otherreport_activity);
        x.view().inject(this);
        ...
        commit_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(et_content.getText().toString().trim())){
                    ...
                    RequestParams params = Utils.getDefaultParams("App/reportOther");
                    params.addBodyParameter("user_token", Utils.getUserToken(OtherReportActivity.this));
