...
public class BadInfoActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.badinfo_activity);
        x.view().inject(this);
        ...
        commit_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(et_content.getText().toString().trim())){
                    ...
                    RequestParams params = Utils.getDefaultParams("App/reportOpinion");
                    params.addBodyParameter("user_token", Utils.getUserToken(BadInfoActivity.this));
